...
def new_orders():
    ...
    customer_data = {
        ...
        "id_customer": id_customer_req
    }

    headers = {'Content-Type': 'application/json'}
    response = requests.post('http://127.0.0.1:8000/customer_orders_ph', headers=headers, data=json.dumps(customer_data))
